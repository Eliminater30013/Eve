...
function love.load()
    ...
    sounds = {
        ...
        ['victory'] = love.audio.newSource('sounds/victory_ff.mp3', 'static')
    }
...
function love.update(dt)
    ...
    -- AI player 1!
    -- if ball.y - 4 <= player1.y  and ball.y + 4 >= player1.y then
    --     player1.dy = 0
    -- elseif ball.y - 4 < player1.y then
    --     player1.dy = -PADDLE_SPEED
    -- elseif ball.y + 4 > player1.y then
    --     player1.dy = PADDLE_SPEED
    -- end
    ...
    if ball.y - 4 <= player2.y  and ball.y + 4 >= player2.y then
        player2.dy = 0
